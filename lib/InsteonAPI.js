...
InsteonAPI.prototype.dataHandler = function(data) {
  var api = this;
...
var sceneProperties = {
  ...
  sceneName: {name: 'SceneName', editable: false, required: true},
  ...
  deviceList: {name: 'DeviceList', editable: false, required: false}
};
