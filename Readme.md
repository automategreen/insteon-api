...
<hr>
*Everything below is copied from the home-controller readme and may change*
<hr>
...
hub.connect(
  process.env.INSTEON_API_KEY,
  process.env.INSTEON_USERNAME,
  process.env.INSTEON_PASSWORD,
  function () {
    app.listen(3000);
  }
);
